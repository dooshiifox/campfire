...
export type GetJoined = FetchErrors<GetJoined> &
	ServerErrors<GetJoined> &
	JsonErrors<GetJoined> &
	AuthErrors<GetJoined> &
	AnyErrors<SdkRequest<GetJoinedResponse, GetJoinedResponse>>;
